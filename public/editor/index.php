...
$(document).ready(function()
{
	...
	Vvveb.Builder.init('/user-data/<?=$_GET["user-id"]?>/<?=$_GET["project"]?>/index.html', function() {
	...
	[
		//{name:"<?=$_GET["project"]?>", title:"<?=$_GET["project"]?>",  url: "/user-data/<?=$_GET["user-id"]?>/<?=$_GET["project"]?>/index.html", assets: ['/user-data/<?=$_GET["user-id"]?>/<?=$_GET["project"]?>/<?=$_GET["project"]?>.css']},
	/*	{name:"landing-page", title:"Landing page",  url: "demo/startbootstrap-landing-page/index.html", assets: ['demo/startbootstrap-landing-page/css/landing-page.min.css']},
		...
		<?php
		   $htmlFiles = glob(__DIR__ . '/../user-data/' . $_GET['user-id'] . '/' . $_GET['project'] . '/*.html');

		   foreach ($htmlFiles as $file) {
			   $pathInfo = pathinfo($file); ?>

         {name:"<?php echo ucfirst($pathInfo['filename']);?>", title:"<?php echo ucfirst($pathInfo['filename']);?>",  url: "/user-data/<?=$_GET["user-id"]?>/<?=$_GET["project"]?>/<?php echo $pathInfo['basename'];?>"},
