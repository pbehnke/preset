...
const banner = ['/*!\n',
  ' * Preset Website Builder - <%= pkg.title %> v<%= pkg.version %> (<%= pkg.homepage %>)\n',
...
function modules() {
  ...
  // js cookie
  var jsCookie = gulp.src('./node_modules/js-cookie/src/js.cookie.js')
      .pipe(uglify())
      .pipe(rename('js.cookie.min.js'))
      .pipe(gulp.dest('./public/assets/vendor/js-cookie'));
  ...
  return merge(bootstrapJS, bootstrapSCSS, bootstrapCSS, dataTables, fontAwesome, jsCookie, jquery, jqueryEasing);
}
